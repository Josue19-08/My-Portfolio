          ...
          >
            <Card className="border border-primary/20 bg-background/50 backdrop-blur-sm h-full">
              <CardContent className="p-6">
                <div className="aspect-square rounded-full overflow-hidden border-4 border-primary/50 mx-auto mb-6 max-w-[250px]">
                  <img src="/thoughtful-gaze.png" alt="Josué Araya" className="w-full h-full object-cover" />
                </div>

                <h3 className="text-2xl font-bold text-center mb-2">Josué Araya</h3>
                <p className="text-center text-primary mb-4">Software Developer</p>

                <div className="flex justify-center gap-2 mb-6">
                  <Badge className="bg-primary">{t("about.englishLevel")}</Badge>
                </div>
            ...
            <Card className="border border-primary/20 bg-background/50 backdrop-blur-sm h-full">
              <CardContent className="p-6">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Hello! I'm Josué Araya, a passionate software developer specializing in web development. I enjoy
